let
  ...
  vm-public-cloud = (builtins.readFile ./hosts/vm-public-cloud/ssh_host_ed25519_key.pub);
...
in
{
  ...
  "hosts/vm-public-cloud/ssh_host_ed25519_key.age".publicKeys = [ vm-public-cloud ] ++ everyone;
  "modules/services/nextcloud/admin-pass.age".publicKeys = [ vm-public-cloud ] ++ everyone;
}
